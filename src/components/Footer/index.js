...
const FooterContainer = styled.div`
  ...
  &::after {
    ...
    top:60px;
    right: 15%;
    background: radial-gradient(circle, rgba(150, 0, 225, 0.3), transparent);
  }
`;
  ...
  return (
    <FooterContainer>
      <FooterWrapper>
        ...
        <Copyright>
          &copy; {new Date().getFullYear()} Pranay Mhatre. All rights reserved.
        </Copyright>
